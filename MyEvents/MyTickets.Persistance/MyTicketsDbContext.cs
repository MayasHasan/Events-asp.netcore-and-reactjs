...
{
    public class MyTicketsDbContext : DbContext
    {
        public MyTicketsDbContext(DbContextOptions<MyTicketsDbContext> options) : base(options) 
        ...
        {
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(MyTicketsDbContext).Assembly);
